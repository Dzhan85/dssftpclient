...
import FTP_ToolbarButton as ToolbarButton
import FTP_FileDialogs as Filedialogs
...
class app:
    ...
    def connect_to_ftp(self, event = None):        
        #Show message box
        self.float_window = Filedialogs.floating_message_dialog(self.master, "FTP", self.connect_icon, "Attempting to connect..." )
    ...
    def update_file_list_thread(self):
        try:
            ...
            thread_request_queue.put(lambda:self.master.wm_title('FTP-'+self.ftpController.pwd()))
            thread_request_queue.put(lambda:self.unlock_status_bar())
        except:
            thread_request_queue.put(lambda:self.unlock_status_bar())
    ...
    def rename_file_thread(self):
        ...
        #Show message box
        self.float_window = Filedialogs.floating_message_dialog(self.master, "SFTP", self.rename_icon, "Renaming file..." )
        #start thread
    ...
    def change_permissions_thread(self):
        ...
        #Show message box
        self.float_window = Filedialogs.floating_message_dialog(self.master, "SFTP client", self.permissions_icon, "Changing file permissions..." )
        #start thread
    ...
    def create_dir_thread(self):
        ...
        #Show message box
        self.float_window = Filedialogs.floating_message_dialog(self.master, "SFTP", self.newfolder_icon, "Creating directory..." )
    ...
    def info(self):
        self.info_window = Filedialogs.about_dialog(self.master, 'About', self.whipFTP_icon)
